...
const GET_YOURSELF = dirname(fileURLToPath(import.meta.url));
const STATES_FILE = join(GET_YOURSELF, 'templates/states.yml');
...
// tracker file so GET_YOURSELF_TRACKER redirects (tests, custom layouts) keep
