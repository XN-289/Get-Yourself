...
// variants: get-yourself-cli/1.3, get-yourself-cli/1.0, get-yourself-cli-seeds/1.0,
// get-yourself-cli-liveness/1.0 — no known reason for the distinct identifiers,
...
export const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; get-yourself-cli/1.0; +https://github.com/santifer/get-yourself-cli)';

/**
 * Browser-like User-Agent for callers that must clear WAF/CDN bot management
 * blocking the plain get-yourself-cli UA outright (seen live: Glints' firewall,
