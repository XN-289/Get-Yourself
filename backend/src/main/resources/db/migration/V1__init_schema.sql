...
('上海青年志愿中心', '公益组织', '长期发布社区陪伴、儿童教育和多文化交流相关实践。', NOW(6)),
('未来职业发展中心', '企业项目', '提供展会运营、职业体验和校企合作项目协助机会。', NOW(6)),
('北大社会调研中心', '大学研究室', '关注城市生活、学生经验和社会调研项目。', NOW(6)),
('Campus Media Studio', '校内组织', '发布线上内容运营、采访编辑和短视频协作任务。', NOW(6)),
('杭州文化交流中心', '文化机构', '围绕地域文化节、翻译协助和跨文化活动招募学生。', NOW(6));
...
('社区儿童阅读陪伴', '上海青年志愿中心', 'PUBLIC_WELFARE', '2026-06-05 15:00:00', '上海 浦东新区',
 '协助社区中心的儿童阅读活动，准备材料、陪伴朗读，并记录活动反馈。', 'SKILL',
 '沟通表达、儿童陪伴、活动记录', NULL, 'seed-social', NOW(6)),
('校园展会现场运营', '未来职业发展中心', 'COMPANY', '2026-06-12 10:30:00', '上海 徐汇区',
 '负责签到、引导、问卷收集和会场整理，适合想接触活动执行的学生。', 'BOTH',
 '现场运营、跨文化沟通、团队协作', 8000.00, 'seed-social', NOW(6)),
('城市生活问卷访谈协助', '北大社会调研中心', 'RESEARCH', '2026-06-18 13:00:00', '北京 海淀区',
...
('西湖文化节翻译协助', '杭州文化交流中心', 'CULTURE', '2026-06-29 09:30:00', '杭州 西湖区',
 '在文化节现场协助英语翻译、游客引导和活动记录。', 'BOTH',
 '英语翻译、公共沟通、活动执行', 5000.00, 'seed-social', NOW(6));

INSERT INTO follows (user_id, organization_name, created_at) VALUES
('demo-student', '上海青年志愿中心', NOW(6)),
('demo-student', '未来职业发展中心', NOW(6));
...
('demo-student', 1, '社区儿童阅读陪伴', '上海青年志愿中心', 'PUBLIC_WELFARE',
 '2026-05-12 15:00:00', '上海 浦东新区',
 '协助社区中心的儿童阅读活动，准备材料、陪伴朗读，并记录活动反馈。', 'SKILL',
 '沟通表达、儿童陪伴、活动记录', NULL, '2026-05-12 18:00:00',
 '负责阅读材料整理、现场引导和儿童朗读陪伴。',
 '更敢和陌生人沟通，也学会了把复杂说明拆成简单步骤。'),
('demo-student', 2, '校园展会现场运营', '未来职业发展中心', 'COMPANY',
 '2026-05-15 10:30:00', '上海 徐汇区',
 '负责签到、引导、问卷收集和会场整理，适合想接触活动执行的学生。', 'BOTH',
