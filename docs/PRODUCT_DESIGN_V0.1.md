...
| Stage 5 | 进行中 | 公司机会流程轨、本地 JD 分析合同 / 报告、公司机会对象、tracker 持久化、节点 mutation 合同与前端显式文件桥已落地；防骗核查闭环、真实产物挂载和页面内 skill 执行未完成 |
...
| 进行中 | 公司机会横向流程轨、节点抽屉、人工节点管理、本地 JD 分析 / 公司机会 / tracker / 节点 mutation 合同，以及导入机会 JSON 与导出节点计划的显式文件桥 | 防骗核查、真实产物挂载和页面内 skill 执行未完成 |
