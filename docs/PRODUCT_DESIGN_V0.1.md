...
| 项目 | 内容 |
|---|---|
| 文档状态 | Agent-first 实现校准修订版 r5，含 2026-09-03 实现进度、Stage 6a 本地确定性构建 / 校验与 Stage 6b 显式本地队列状态、下一步统一验收与 6c 门槛；待产品与技术评审与用户统一验收 |
| 产品阶段 | v0.1 最小闭环设计 |
...
3. 简历管理：成品导入、简历线、草稿派生、定稿、当前投递版、导出标记和事实链状态。
